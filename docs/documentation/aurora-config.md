...
| `database/<name>/secretName`             |                                        | Override default name for the created secret, requirements: only alphanumeric and '-' or '.', must start and end with alphanumeric, no longer than 253 characters.                                                        |
