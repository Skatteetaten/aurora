...
| toxiproxy/endpointsFromConfig/\<name\>                              | false              | <name> is the name of the environment variable to manipulate. This variable must be present in the config section and contain a valid URL. If set to `true`, this will enable a Toxiproxy proxy for this URL with an automatically generated proxy name.                                                                                                                                                                                                                            |
| toxiproxy/endpointsFromConfig/\<name\>/enabled                      | true               | Set to `true` to create a Toxiproxy proxy for the URL given in the environment variable with the name \<name\>. If set to `false`, it will be skipped. Not to be confused with the _enabled_ state of the proxy, which is set by _initialEnabledState_.                                                                                                                                                                                                                             |
| toxiproxy/endpointsFromConfig/\<name\>/proxyname                    | endpoint\_\<name\> | Set the name of the Toxiproxy proxy.                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| toxiproxy/endpointsFromConfig/\<name\>/initialEnabledState          | true               | Set the _enabled_ state of the proxy.                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| toxiproxy/serverAndPortFromConfig/\<proxyname\>/serverVariable      |                    | Name of the environment variable that holds the host. This variable must be present in the config section and contain a valid host name. <proxyname> is the name of the Toxiproxy proxy that will be created.                                                                                                                                                                                                                                                                       |
| toxiproxy/serverAndPortFromConfig/\<proxyname\>/portVariable        |                    | Name of the environment variable that holds the port. This variable must be present in the config section and contain a valid port number. <proxyname> is the name of the Toxiproxy proxy that will be created.                                                                                                                                                                                                                                                                     |
| toxiproxy/serverAndPortFromConfig/\<proxyname\>/initialEnabledState | true               | Set the _enabled_ state of the proxy.                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| toxiproxy/database                                                  | false              | Set to `true` to enable Toxiproxy for all databases defined in the database config section.                                                                                                                                                                                                                                                                                                                                                                                         |
| toxiproxy/database/\<name\>                                         | false              | \<name\> is the name of the database. It must be present in database config section. If set to `true`, this will enable a Toxiproxy proxy for this database with an automatically generated proxy name.                                                                                                                                                                                                                                                                             |
| toxiproxy/database/\<name\>/enabled                                 | true               | Set to `true` to create a Toxiproxy proxy for the database with the name \<name\>. If set to `false`, it will be skipped. Not to be confused with the _enabled_ state of the proxy, which is set by _initialEnabledState_.                                                                                                                                                                                                                                                          |
| toxiproxy/database/\<name\>/proxyname                               | database\_\<name\> | Set the name of the Toxiproxy proxy.                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| toxiproxy/database/\<name\>/initialEnabledState                     | true               | Set the _enabled_ state of the proxy.                                                                                                                                                                                                                                                                                                                                                                                                                                               |
