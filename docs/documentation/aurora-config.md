...
| toxiproxy/endpointsFromConfig/\<name\>/enabled                      | false             | Set to true to create a Toxiproxy proxy for the URL given in the environment variable with the name \<name\>. Not to be confused with the _enabled_ state of the proxy, which is set by _initialEnabledState_.                                                                                                                                                                                                                                                                      |
| toxiproxy/endpointsFromConfig/\<name\>/proxyname                    | endpoint_\<name\> | Set the name of the Toxiproxy proxy.                                                                                                                                                                                                                                                                                                                                                                                                                                                |
...
| `alerts/<alertName>/connections` |                                      | Array of connection rules between alert definition and recipients via specific channels, when this is set then `connection` will be ignored |
...
| `alertsDefaults/connections` |         | Array of connection rules between alert definition and recipients via specific channels, when this is set then `connection` will be ignored |
