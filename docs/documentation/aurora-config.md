...
| resourcequota/pv/size           | No       |              | No           | Maximum storage size in ResourceQuota for PersistentVolumeClaims. Requires that resourcequota/pv/count is specified.                                                                                                                                                           |
| resourcequota/pv/count          | No       |              | No           | Maximum amount of PersistentVolumeClaims specified in ResourceQuota. Requires that resourcequota/pv/size is specified.                                                                                                                                                         |
