...
| toxiproxy/endpointsFromConfig/\<name\>                         | false             | <name> is the name of the environment variable to manipulate. This variable must be present in the config section and contain a valid URL. If set to `true`, this will enable a Toxiproxy proxy for this URL with an automatically ganerated proxy name.                                                                                                                                                                                                                            |
| toxiproxy/endpointsFromConfig/\<name\>/enabled                 | false             | Set to true to enable a Toxiproxy proxy for the URL given in the environment variable with the name <name>.                                                                                                                                                                                                                                                                                                                                                                         |
| toxiproxy/endpointsFromConfig/\<name\>/proxyname               | endpoint_\<name\> | Sets the proxy name of the Toxiproxy proxy.                                                                                                                                                                                                                                                                                                                                                                                                                                         |
