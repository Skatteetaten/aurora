...
| toxiproxy/endpointsFromConfig/\<name\>/enabled                 | false             | Set to true to create a Toxiproxy proxy for the URL given in the environment variable with the name <name>.                                                                                                                                                                                                                                                                                                                                                                         |
