...
| env/tts                         |          |              | No           | Set a time duration in format 1d, 12h that indicate how long until this namespace should be put to sleep (scale down all applications to 0)                                                                                                                                                                                              |
...
| tts                 |          |                | No           | Set a time duration in format 1d, 12h that indicate how long until this application should be put to sleep (scale down application to 0)                                                                                                          |
...
| startupProbe                                        | false       | Toggle to true to enable startup probe                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| startupProbe/port                                   | 8080        | If no path present liveness will check if this port is open                                                                                                                                                                                                                                                                                                                                                                                                                         |
| startupProbe/path                                   |             | Set to a path to do a GET request to that path as a startup probe check                                                                                                                                                                                                                                                                                                                                                                                                             |
| startupProbe/delay                                  | 10          | Number of seconds to wait before running startup probe check                                                                                                                                                                                                                                                                                                                                                                                                                        |
| startupProbe/timeout                                | 1           | Number of seconds timeout before giving up startup probe check                                                                                                                                                                                                                                                                                                                                                                                                                      |
| startupProbe/periodSeconds                          | 10          | Number of seconds between each startup probe check                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| startupProbe/failureThreshold                       | 3           | Number of times to retry startup probe check on failure                                                                                                                                                                                                                                                                                                                                                                                                                             |
...
| podDisruptionBudget/minAvailable | 1       | Minimum available healthy pods required. The feature will be enabled if this field is explicitly set. |
