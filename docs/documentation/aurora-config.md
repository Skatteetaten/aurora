...
| env/resourcequota/pv/totalSize  | No       |              | No           | Maximum storage size in ResourceQuota for PersistentVolumeClaims. Requires that env/resourcequota/pv/count is specified.                                                                                                                                                       |
| env/resourcequota/pv/count      | No       |              | No           | Maximum amount of PersistentVolumeClaims specified in ResourceQuota. Requires that env/resourcequota/pv/size is specified.                                                                                                                                                     |
